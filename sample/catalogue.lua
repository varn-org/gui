...
local GROUPS = {
    ...
    { key = "writing", title = "Writing", module = "demos.writing" },
    { key = "drawing", title = "Drawing", module = "demos.drawing" },
    { key = "frames", title = "Frames from artwork", module = "demos.frames" },
    { key = "place", title = "Maps and location", module = "demos.place" },
    { key = "capture", title = "Camera and sound", module = "demos.capture" },
    ...
    { key = "themes", title = "Themes", module = "demos.themes" },
    { key = "controls", title = "Controls", module = "demos.controls" },
    { key = "more", title = "More controls", module = "demos.more" },
